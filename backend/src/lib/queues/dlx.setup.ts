// ============================================================================
// DEAD LETTER EXCHANGE (DLX) SETUP - FOR FAILED MESSAGE HANDLING
// ============================================================================
// File: src/lib/queues/dlx.setup.ts
// Purpose: Handle failed messages, retries, and error logging
// NOTE: DLX is now ONLY for failed messages, NOT for scheduling!
//       Scheduling uses the Delayed Message Exchange Plugin.
// ============================================================================

import { Channel } from "amqplib";
import { EXCHANGES, QUEUES } from "./types";
