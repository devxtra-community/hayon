...
import { Sidebar, Header, PlanInfoCard } from '@/components/dashboard';
...
export default function SettingsPage() {
    ...
    const handleDeleteAvatar = () => {
        api.delete('/profile/delete-avatar').then((res) => {
            setUpdate(!update);
                                ...
                                <div className="space-y-8 mb-8">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative h-12 w-full bg-gray-50 rounded-full overflow-hidden border border-gray-100">
                                            <div className="absolute inset-0" style={{ backgroundImage: `repeating-linear-gradient(45deg, transparent, transparent 10px, #e5e7eb 10px, #e5e7eb 20px)` }} />
                                ...
                                <div className="space-y-6">
                                    {platforms.map((platform) => (
                                        <div key={platform.name} className="flex items-center justify-between">
                                            ...
                                            <Button
                                                variant="outline"
                                                className={`rounded-full px-6 h-9 text-xs font-medium border-gray-200 ${platform.status === "connected"
